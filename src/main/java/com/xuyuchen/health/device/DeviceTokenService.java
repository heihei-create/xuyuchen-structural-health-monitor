...
public class DeviceTokenService {
    ...
    private void devicesCheck(String projectId, String deviceId) { if (projectId.isBlank() || deviceId.isBlank()) throw new IllegalArgumentException("project and device required"); }
}
